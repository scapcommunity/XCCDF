...
| changelog (element) | _special_ | 0-1 | Holds the change history of the item in form of a sub element for each version in which a change to the item occured. See Section 6.4.1.1. |
...
#### 6.4.1.1 \<xccdf:changelog\> Element

XCCDF items can carry an item-specific changelog. It contains 0-n \<xccdf:change\> elements;
a \<xccdf:change\> element has the following properties:

**Table TODO_change_element: \<xccdf:change\> Element Properties**
